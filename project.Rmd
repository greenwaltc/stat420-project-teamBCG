...
crops.train$Production = crops$Production + 1
crops.test$Production = crops.test$Production + 1
...
```{r}
multi.aic.forward.bc.cropyear_cont <- step(lm(bc_transform(Production, lambda) ~ 1, data = crops.train.multi.no_infl),
                                           scope = as.formula(
                                             paste("bc_transform(Production, lambda) ~ ",
                             paste(attr(terms(multi.form.cropyear_cont),
                                        which = "term.labels"),
                                   collapse = " + "))
                                           ),
...
```{r}
multi.bic.forward.bc.cropyear_cont <- step(lm(bc_transform(Production, lambda) ~ 1, data = crops.train.multi.no_infl),
                                           scope = as.formula(
                                             paste("bc_transform(Production, lambda) ~ ",
                             paste(attr(terms(multi.form.cropyear_cont),
                                        which = "term.labels"),
...
(multi.full.cropyear_cat_lambda <- bc$x[which.max(bc$y)])
...
```{r}
multi.aic.forward.bc.cropyear_cat <- step(lm(bc_transform(Production, lambda) ~ 1, data = crops.train.multi.no_infl),
                                           scope = as.formula(
                                             paste("bc_transform(Production, lambda) ~ ",
                             paste(attr(terms(multi.form.cropyear_cat),
                                        which = "term.labels"),
...
```{r}
multi.bic.forward.bc.cropyear_cat <- step(lm(bc_transform(Production, lambda) ~ 1, data = crops.train.multi.no_infl),
                                           scope = as.formula(
                                             paste("bc_transform(Production, lambda) ~ ",
                             paste(attr(terms(multi.form.cropyear_cat),
                                        which = "term.labels"),
...
```{r}
multi.aic.forward.bc.cropyear_omit <- step(lm(bc_transform(Production, lambda) ~ 1, data = crops.train.multi.no_infl),
                                           scope = as.formula(
                                             paste("bc_transform(Production, lambda) ~ ",
                             paste(attr(terms(multi.form.cropyear_omit),
                                        which = "term.labels"),
...
```{r}
multi.bic.forward.bc.cropyear_omit <- step(lm(bc_transform(Production, lambda) ~ 1, data = crops.train.multi.no_infl),
                                           scope = as.formula(
                                             paste("bc_transform(Production, lambda) ~ ",
                             paste(attr(terms(multi.form.cropyear_omit),
                                        which = "term.labels"),
